...
function Login() {
  ...
  <div className="w-full max-w-screen-lg">
    ...
    <span className="font-DancingScript text-3xl text-red-600 ">Choose your footwear</span>
  </div>

        {/* <!-- Your form content --> */}
        <div className="mb-4">
          <label className="block text-gray-700 text-base font-DancingScript  mb-2 transition-all duration-300 hover:py-3 hover:px-4">Username</label>
        ...
        <div className="mb-4">
          <label className="block text-gray-700 text-base font-DancingScript mb-2 transition-all duration-300 hover:py-3 hover:px-4"  >Contact No:</label>
        ...
        <div className="mb-6">
          <label className="block text-gray-700 text-base font-DancingScript mb-2 transition-all duration-300 hover:py-3 hover:px-4"  >Password</label>
        ...
        <div className="flex items-center justify-between">
          <button className="bg-blue-500 hover:bg-blue-700 text-white font-DancingScript py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">Sign In</button>
        </div>
      </div>
    </form>
  </div>
